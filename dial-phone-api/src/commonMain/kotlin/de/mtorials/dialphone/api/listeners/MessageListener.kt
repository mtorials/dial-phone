...
class MessageListener(
    ...
    private val messagesByRoom: MutableMap<String, MutableList<de.mtorials.dialphone.api.entities.Message>> = mutableMapOf()
     ...
     */
    fun getMessages(roomId: String) : List<de.mtorials.dialphone.api.entities.Message> = messagesByRoom[roomId] ?: listOf()
}